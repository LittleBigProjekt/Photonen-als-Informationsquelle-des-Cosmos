...
> herleitet. Eine echte unabhängige Validierung verlangt, zuvor die
> offenen Punkte K6 und K7 zu schließen; sie ist Gegenstand eines
> späteren Bausteins 5.
...
## 4.9 Offene Punkte und nächster Schritt

- **K6** — Amplituden-Konstante \( A \): offen.
- **K7** — Übergang zur Modalbasis (sphärische Streumoden): offen.
- **Baustein 5** — unabhängige Validierung: setzt K6 und K7 voraus.
...
Validierung steht noch aus (Baustein 5, nach K6 und K7).
