...
### H4 — Farbabhängige Lichtgeschwindigkeit im Vakuum (geprüft und verworfen)

> **Status: geprüfter und verworfener Gedanke.** Anders als H1–H3 ist H4
> keine offene Hypothese mehr. Der Gedanke wurde erwogen und an Beobachtungen
> geprüft; die Beobachtungslage spricht klar dagegen. H4 wird hier vollständig
> dokumentiert — damit der Denkweg nachvollziehbar bleibt und bei späteren
> Fachgesprächen gezeigt werden kann, dass er geprüft wurde.

- **Ursprünglicher Gedanke:** Verschiedene Lichtfarben könnten sich im Vakuum
  mit *unterschiedlicher* Geschwindigkeit ausbreiten. Sterne könnten dann rot,
  blau oder weiß erscheinen, weil von einem fernen Stern zuerst eine Farbe
  ankommt und die übrigen noch unterwegs sind.
- **Motivation:** Die Beobachtung, dass Sterne verschiedene Farben haben; der
  Gedanke, dass „gleichzeitige Ankunft" nicht zwingend „gleichzeitiger Start"
  bedeutet.
- **Warum der Gedanke nicht trägt — die Gegenbeobachtungen:**
  1. *Plötzliche Ereignisse.* Supernovae und Gammablitze senden in einem
     Moment Licht aller Farben aus. Sie werden routinemäßig in allen Farben
     **gleichzeitig** aufleuchten gesehen — auch über Distanzen von Millionen
     bis Milliarden Lichtjahren. Bei farbabhängiger Geschwindigkeit müssten
     die Farben um Monate bis Jahre versetzt eintreffen.
  2. *Ereignis von 2017 (Licht + Gravitationswellen).* Aus 130 Millionen
     Lichtjahren Entfernung kamen die verschiedenen Lichtfarben desselben
     Ereignisses ohne messbaren Zeitunterschied an. Schon ein Geschwindigkeits-
     unterschied von einem Milliardstel ergäbe über diese Distanz einen
     Ankunftsunterschied von über einem Monat — beobachtet wird praktisch null.
  3. *Stabile Sternfarben.* Sternfarben sind über Jahrhunderte konstant; schon
     antike Beschreibungen nennen dieselben Farben wie heute. Bei
     farbabhängiger Geschwindigkeit müsste jeder Stern langsam die Farbe
     wechseln.
  4. *Weiße Sterne.* Weiß ist die Mischung aller Farben gleichzeitig. Kämen
     die Farben zeitversetzt an, könnte ein Stern nie weiß erscheinen — weiße
     Sterne gibt es aber zahlreich.
- **Die etablierte Erklärung der Sternfarben:** Die Farbe eines Sterns verrät
  seine *Temperatur* — exakt dasselbe Prinzip wie beim glühenden Eisen
  (Abschnitt 4.1, Plancksches Strahlungsgesetz). Kühle Sterne (~3000 °C) sind
  rot, mittlere (~5500 °C) gelblich-weiß, heiße (20.000 °C und mehr)
  blau-weiß. Ein Stern sendet alle Farben gleichzeitig aus; die Temperatur
  bestimmt nur, welcher Farbanteil überwiegt.
- **Was als echter offener Rest bleibt:** Zwei verwandte, *seriöse* Punkte
  sind hiervon unberührt und bleiben gültig: (a) In *Materie* haben
  verschiedene Farben tatsächlich verschiedene Geschwindigkeiten — die
  *Dispersion*, etablierte Physik, Grund der Prismenzerlegung. (b) An den
  Rändern der aktuellen Physik wird experimentell weiter geprüft, ob die
  Vakuum-Lichtgeschwindigkeit *exakt* farbunabhängig ist; das ist aktive
  Forschung, betrifft aber allenfalls winzigste Effekte — nicht den
  ursprünglichen Gedanken sichtbar farbwechselnder Sterne.
...
> klassischen Notation getrennten Theorie-Zweig. H4 ist demgegenüber ein
> geprüfter und an Beobachtungen verworfener Gedanke; er ist zur
> Nachvollziehbarkeit dokumentiert, nicht zur Weiterverfolgung.
